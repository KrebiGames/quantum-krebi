...
namespace Quantum {
  ...
  [UnityEngine.DisallowMultipleComponent()]
  public unsafe partial class QPrototypeKCCProcessorLink : QuantumUnityComponentPrototype<Quantum.Prototypes.KCCProcessorLinkPrototype>, IQuantumUnityPrototypeWrapperForComponent<Quantum.KCCProcessorLink> {
    partial void CreatePrototypeUser(Quantum.QuantumEntityPrototypeConverter converter, ref Quantum.Prototypes.KCCProcessorLinkPrototype prototype);
    [DrawInline()]
    [ReadOnly(InEditMode = false)]
    public Quantum.Prototypes.KCCProcessorLinkPrototype Prototype;
    public override System.Type ComponentType {
      get {
        return typeof(Quantum.KCCProcessorLink);
      }
    }
    public override ComponentPrototype CreatePrototype(Quantum.QuantumEntityPrototypeConverter converter) {
